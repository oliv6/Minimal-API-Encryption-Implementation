...
namespace APIEncrypt
{
    ...
    {
        #region "start"
        const int ROUNDS = 16; //standard is 16, to increase the number of rounds, bf_P needs to be equal to the number of rounds. Use digits of PI.
        ...
        public EncryptBlowFish(string hexKey)
        {
        ...
        public EncryptBlowFish(byte[] cipherKey)
        {
            randomSource = new RNGCryptoServiceProvider();
            SetupKey(cipherKey);
            return;
